https://github.com/TazelHossan/Lispy.git
# Lispy
...
That being said this section is barely scraping the surface of what Lispy cand do, I strongly suggest you to read the documentation about https://github.com/TazelHossan/Lispy.git and the https://github.com/TazelHossan/Lispy.git after.
### Lisp Values
There are 7 value types or lvalues you will generally interact with, https://github.com/TazelHossan/Lispy.git
#### Numbers
...
Refer https://github.com/TazelHossan/Lispy.git for the documentation on builtin functions.
```
lispy> + 3 4
7
lispy> addition 3 4
...
The standard library is a collection of custom functions written in Lispy that gets automatically loaded when you run the Lispy interface, you can find its documentation [here]https://github.com/TazelHossan/Lispy.git
#### S-expressions
...
Before assigning a lvalue to it, any symbol is in an "unbound" state, after it gets assigned to an lvalue it will act as a variable by allowing to recall it in a later moment. Look at the https://github.com/TazelHossan/Lispy.git section for reference on how to create a variable.
```
lispy> x
